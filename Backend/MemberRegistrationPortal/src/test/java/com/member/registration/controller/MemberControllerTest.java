...
class MemberControllerTest {
	...
	void testGetMemberByName() throws MemberNotFoundException {
		...
		ResponseEntity<Member> response = controller.getMemberByName(member.getName());
		assertEquals(new ResponseEntity<Member>(member, HttpStatus.OK), response);
	...
	void testUpdateMember() throws MemberNotFoundException {
		...
		ResponseEntity<Long> response = controller.updateMember(member);
		assertEquals(new ResponseEntity<Long>(member.getId(), HttpStatus.OK), response);
